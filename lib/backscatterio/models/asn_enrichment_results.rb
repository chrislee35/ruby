...
module BackscatterIO
  class ASNEnrichmentResults
    attr_accessor :as_num

    attr_accessor :as_name

    attr_accessor :prefix_count
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'prefix_count')
        self.prefix_count = attributes[:'prefix_count']
      end
    ...
    def hash
      [as_num, as_name, prefix_count, prefixes].hash
    end
